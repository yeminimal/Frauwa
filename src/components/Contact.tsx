    ...
    <section id="contact" className="py-24 bg-frauwa-50">
      <div className="container max-w-7xl mx-auto px-6 md:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2
            className="text-4xl md:text-5xl font-display tracking-tightest animate-reveal text-frauwa-800"
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          ...
          <div className="md:col-span-3 flex flex-col items-center justify-center bg-white rounded-2xl shadow-card p-8 animate-reveal">
            <h3 className="font-display text-3xl mb-6 text-frauwa-800 text-center">
            ...
            <Button
              size="lg"
              className="bg-frauwa-800 hover:bg-frauwa-900 text-white rounded-full px-8 py-7 text-base button-hover-effect group w-auto max-w-full"
